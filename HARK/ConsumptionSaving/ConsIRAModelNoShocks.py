...
def main():
    ...
    IRAexample = IRAConsumerType(**Params.init_IRA_30_no_shocks)
    ...
    KinkedExample = KinkedRconsumerType(**Params.init_IRA_30_no_shocks)
    ...
    np.savetxt('IRA_Results/a_30_no_shocks.csv',IRAexample.aNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/b_30_no_shocks.csv',IRAexample.bNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/m_30_no_shocks.csv',IRAexample.mNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/n_30_no_shocks.csv',IRAexample.nNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/c_30_no_shocks.csv',IRAexample.cNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/d_30_no_shocks.csv',IRAexample.dNrmNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/p_30_no_shocks.csv',IRAexample.pLvlNow_hist.T,delimiter=',')
    np.savetxt('IRA_Results/t_30_no_shocks.csv',IRAexample.t_age_hist.T,delimiter=',')
