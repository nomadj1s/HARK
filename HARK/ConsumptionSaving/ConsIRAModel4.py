...
def main():
    ...
    IRASolverExample.prepareToSolve()
    aNrm,bNrm = IRASolverExample.prepareToCalcEndOfPrdvAndvP()
    EndOfPrdv,EndOfPrdvP = IRASolverExample.calcEndOfPrdvAndvP(
                                                     IRASolverExample.mNrmNext,
                                                     IRASolverExample.nNrmNext,
                                             IRASolverExample.PermShkVals_temp,
                                                 IRASolverExample.ShkPrbs_temp,
                                                    IRASolverExample.Rfree_Mat)
    cNrm,lNrm = IRASolverExample.getPointsForPureConsumptionInterpolation(
                                                                     EndOfPrdv,
                                                                    EndOfPrdvP,
                                                      IRASolverExample.aNrmNow)
    IRASolverExample.makePurecFunc(cNrm,lNrm,IRASolverExample.bNrmNow)
    IRASolverExample.makeEndOfPrdvFunc(EndOfPrdv)
